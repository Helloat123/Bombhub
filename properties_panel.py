...
class PropertiesPanel():
	...
	def draw_panel(screen, player_id, HP, speed, scope, bombs):
		...
		screen.blit(pygame.image.load('resources/image/numback_2.png').convert_alpha(), (730, y))
	...
	def showHelp(screen):
		...
		first_y = 20
		screen.blit(PropertiesPanel.build_text('Instruction'),(x+230,y+first_y))
		screen.blit(PropertiesPanel.build_text('Player1:'),(x+30,y+first_y+30))
		screen.blit(PropertiesPanel.build_text('W:up A:left S:down D:right Space:bomb'),(x+30,y+first_y+30+30))
		screen.blit(PropertiesPanel.build_text('Player2:'),(x+30,y+first_y+30+30+30))
		screen.blit(PropertiesPanel.build_text('↑:up ←:left ↓:down →:right Num0:bomb'),(x+30,y+first_y+30+30+30+30))
		screen.blit(PropertiesPanel.build_text('Developers(Ordered by Pinin):'),(x+30,y+first_y+30+30+30+30+60))
		screen.blit(PropertiesPanel.build_text('刘子琦 杨曜铭 张天麟 朱睿诚'),(x+30,y+first_y+30+30+30+30+60+30))
		return x, y, w
